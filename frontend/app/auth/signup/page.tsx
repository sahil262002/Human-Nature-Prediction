...
export default function Signup() {
  ...
  return (
    <>
      <div
        className="flex flex-col items-center justify-center w-full h-[calc(100vh-4rem)] bg-cover bg-center"
        style={{
          backgroundImage: "url('/bg.jpg')", // Path to your background image
        }}
      >
        <div className="flex justify-center w-full">
          <div className="border-solid border-2 border-slate-800 rounded-lg border-t-4 shadow-indigo-500/50 shadow-2xl max-w-xs w-full p-8 bg-transparent">
            <div className="m-3">
              <div>
                <input
